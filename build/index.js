...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Siftout = __webpack_require__(299);

	var _Siftout2 = _interopRequireDefault(_Siftout);
	...
	function init() {
	  ...
	  var siftout = new _Siftout2.default();
	  console.dir(siftout);
	}
	...
	var Siftout = function () {
	  ...
	  _createClass(Siftout, [{
	    ...
	    value: function prevRowMaxHeight(itemId) {
	      ...
	      var itemIdOnRow = iRow * this.opt.columns;
	    ...
	    value: function updateGridHeight() {
	      ...
	      console.dir(this.rowsMaxHeights);
	      console.log(height);
	      console.log(highestCol.length);
	      console.log((highestCol.length - 1) * this.opt.rowGap);
